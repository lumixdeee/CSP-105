...
- Mogri [RUN] is an irreducible held-open runtime condition



- VIEW primitives map to the nearest semantically dominant CORE (e.g., Presence -> Being, Metric -> Measurement, Capacity -> Resource).

- RUN entries may be active runtime agents (e.g., Dragon, Wadri) or non-entity runtime conditions (e.g., Mogri).
---
...
- Mogri (Primitive 94) is treated as a foundational conceptual/cognitive container for holding important unresolved potential before a useful distinction is fixed.
...
Definition: Irreducible held-open condition before a useful distinction is fixed.
Examples: unresolved intent, live possibility, partly inaccessible meaning
...
- Mogri can function as a **foundational cognitive container** for holding an important unresolved object before a useful distinction is fixed.
- It is *not* a derivative primitive and cannot be constructed from other primitives.
- It is a **runtime condition**, not an entity, cause, or generator.
...
- Dates and examples are approximate.
