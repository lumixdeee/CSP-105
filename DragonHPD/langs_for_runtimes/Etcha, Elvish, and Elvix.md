...
This is not merely a linguistic proposal. It is also a runtime-design proposal. The system attempts to unify:
...
The system is composed of three layers that share a common root but serve different functions:
            ...
            │     Elvix     │    │    Elvish     │   
            └───────────────┘    └───────────────┘
     formal, deterministic    expressive, human, situational
...
Elvix is the formal layer. It is designed for:
...
This sequence appears repeatedly in higher constructs.
...
Conflict is defined by outcome state, not emotion.
...
From this, transformations generate the operator set:
...
The system identifies a small set of functional roles:
...
meaning → primitives → formal expression
